...
1. Help me remember the Mandarin Chinese word for hospital with pun-based mnemonics. 
2. Generate 3 pun-based mnemonics for 'sky' in French (include Wiktionary links to double-check meaning and pronunciation). 
3. Create pun-based mnemonics for: 'house', 'cat', 'tree' in Japanese (include Wiktionary links to double-check meaning and pronunciation). 
4. I need help remembering 'tree' in Portuguese (include Wiktionary links to double-check meaning and pronunciation). Generate pun-based mnemonics. 
