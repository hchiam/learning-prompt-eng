export default function generatePrompt(language, word) {
  ...
  const prompt = `The French word "gare" means "railway station" in English. Check with this source: https://en.wiktionary.org/wiki/gare#French 
